...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ points, onPointSelect, userCoords }) => {
  ...
  return (
    <div className="bg-gray-100 p-4 h-full w-full overflow-y-auto" style={{ width: '100%', height: '100%' }}>
      ...
      {!userCoords ? (
        ...
        <p className="text-gray-500">No hay puntos disponibles en el área visible del mapa.</p>
      ) : (
            ...
            .map((point) => (
              ...
              >
                <h3 className="font-semibold text-blue-700">
                  {point.name} {loggedInUser && !point.isActive && ' *'} {/* Asterisco para puntos inactivos si está logueado */}
                </h3>
